#ifndef OPENGLPROGRAM_util_H_
#define OPENGLPROGRAM_util_H_
...
protected:
  ...
  void CaptureViewPortFloatToFloat(cv::Mat &capture, GLenum format = GL_BGR_EXT, GLuint ch=3, GLuint framebuf=0);
  bool initGlwf();
  void init();
  void checkLastError();
